...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="w-full px-4 py-10 lg:p-28 flex flex-col justify-start items-start gap-6 lg:gap-12"
    >
      ...
      <div className="w-full flex flex-col lg:flex-row justify-start items-start gap-6">
        {/* Mobile: Image first */}
        <div className="w-full lg:hidden h-64 bg-slate-200 rounded-[20px] relative overflow-hidden">
          <Image
            src="/images/bishan-park-2.webp"
            alt="Kettlebell training at Bishan Park"
            fill
        ...
        <div className="hidden lg:block flex-1 h-[452px] bg-slate-200 rounded-[20px] relative overflow-hidden">
          <Image
            src="/images/bishan-park-5_compressed.jpg"
            alt="Kettlebell training at Bishan Park"
            fill
            className="object-cover"
          />
