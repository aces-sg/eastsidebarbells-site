    ...
    <header className="bg-sky-50 fixed top-0 left-0 right-0 z-50 mx-auto w-full">
      <div className="h-24 px-6 lg:px-28 py-6 flex justify-between items-center overflow-hidden">
              ...
              <Link
                ...
                className={`text-base font-normal leading-relaxed transition-colors ${
                  index === 0
                    ...
                    : "text-slate-500 hover:text-stone-950"
                }`}
              >
                {item.text}
              </Link>
        ...
        <div className="hidden md:block">
          <Link
            href="https://www.meetup.com/kettlebell-and-sunshine/events/?eventOrigin=home_groups_you_organize"
            target="_blank"
        ...
        <div id="mobile-menu" className="md:hidden bg-white shadow-lg">
          <ul className="flex flex-col space-y-4 pt-1 pb-6 px-6">
            ...
            <li>
              <Link
                href="#cta"
                className="text-black bg-primary hover:bg-primary-accent px-5 py-2 rounded-lg block w-fit"
                onClick={toggleMenu}
              >
                Download App
              </Link>
