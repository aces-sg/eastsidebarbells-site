...
const Features: React.FC = () => {
  ...
  return (
    <section
      id="features"
      className="w-full px-4 py-12 lg:px-28 lg:py-20 flex flex-col justify-start items-start gap-8 lg:gap-12"
    >
      {/* Mobile Carousel */}
      <div className="w-full lg:hidden flex flex-col justify-start items-start gap-8">
        <div className="w-full flex flex-col justify-start items-start gap-4">
          ...
          <p className="w-full text-slate-500 text-base font-normal leading-relaxed">
            Our all-in-one fitness management solution empowers you to
            revolutionize your fitness journey. Seamlessly train smarter,
            optimizing your workouts with personalized insights and data-driven
            recommendations.
          </p>
        </div>
        <div className="w-full h-72 px-4 py-5 bg-lime-100 rounded-[20px] flex flex-col justify-start items-start gap-2.5 overflow-hidden">
          <div className="w-full flex-1 bg-slate-200 rounded-lg relative overflow-hidden">
            <Image
              src="/images/kettlebell-2.jpg"
              alt="Feature mockup"
              fill
      ...
      <div className="hidden lg:flex w-full justify-start items-start gap-12">
        <div className="flex-1 flex flex-col justify-between items-start">
          ...
          <div className="w-full flex justify-between items-center">
            <div className="text-stone-950 text-xl font-medium leading-loose"></div>
            <div className="h-14 flex justify-start items-center gap-4 mt-12">
              <button
                onClick={handlePrevious}
        ...
        <div className="w-[575px] p-7 bg-lime-100 rounded-[20px] flex flex-col justify-start items-start gap-2.5 overflow-hidden">
          <div className="w-full h-[466px] bg-slate-200 rounded-lg relative overflow-hidden">
            <Image
              src="/images/kettlebell-1.jpg"
              alt="Feature mockup"
              fill
              className="object-cover"
            />
