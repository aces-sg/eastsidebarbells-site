...
const HowItWorks: React.FC = () => {
    return (
        <section id="how-it-works" className="w-full p-6 lg:p-28 bg-sky-50 flex flex-col lg:flex-row justify-between items-start gap-12 overflow-hidden">
            ...
            <div className="w-full lg:w-[567px] relative flex flex-col justify-start items-start gap-10 lg:gap-14">
                ...
                {howItWorksData.steps.map((step, index) => (
                    <div key={index} className="w-full flex justify-start items-start gap-6">
