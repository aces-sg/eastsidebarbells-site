...
const FAQ: React.FC = () => {
    ...
    return (
        <section id="faq" className="w-full p-6 lg:p-28 flex flex-col lg:flex-row justify-start items-start gap-12">
            <div className="w-full lg:w-96 flex flex-col justify-between items-start gap-8">
                <div className="w-full flex flex-col justify-start items-start gap-4">
                    <div className="h-10 px-4 pt-3.5 pb-4 bg-sky-50 rounded-[500px] inline-flex justify-center items-center gap-2 overflow-hidden">
                        <div className="justify-start text-stone-950 text-base font-semibold leading-tight">FAQ</div>
                    </div>
                    ...
                    <p className="w-full text-slate-500 text-base font-normal leading-relaxed">
                        Here&apos;s everything you need to know to get started to reach your fitness goals.
                    </p>
                </div>
                <div className="w-full flex flex-col justify-start items-start gap-4">
                    <p className="w-full text-slate-500 text-base font-normal leading-relaxed">
                    ...
                    >
                        <div className="justify-start text-stone-950 text-base font-semibold leading-tight">Contact Us</div>
                    </Link>
                </div>
            </div>
