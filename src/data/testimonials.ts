...
export const testimonials: ITestimonial[] = [
  ...
  },
  {
    ...
    message:
      "FitMove has transformed how I train my clients. The data-driven insights help me optimize every session, and my clients love tracking their progress in real-time.",
